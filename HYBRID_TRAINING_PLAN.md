...
## 5. Immediate Action Items (Sprint 1)

1. [ ] **Update ETL script** ([scripts/download_comptox.py](file:///home/tringuyen/Documents/GitHub/Predictive-Modeling-of-Pharmacological-Properties-using-Graph-Neural-Networks/scripts/download_comptox.py)): Replace deprecated EPA FTP links with active CCTE Zenodo / HuggingFace chemical snapshots.
2. [ ] **Refine SMARTS Definitions** ([main.py](file:///home/tringuyen/Documents/GitHub/Predictive-Modeling-of-Pharmacological-Properties-using-Graph-Neural-Networks/main.py)): Add biological phosphate exclusion rules so nucleotides (ATP, ADP) do not trigger false-positive pesticide alerts.
3. [ ] **Implement Scaled Backbone** ([model.py](file:///home/tringuyen/Documents/GitHub/Predictive-Modeling-of-Pharmacological-Properties-using-Graph-Neural-Networks/model.py)): Support configurable `hidden_channels=128` and residual connections with parameter initialization.
4. [ ] **Run Pretraining Smoke Test**: Test [scripts/phase2_pretrain.py](file:///home/tringuyen/Documents/GitHub/Predictive-Modeling-of-Pharmacological-Properties-using-Graph-Neural-Networks/scripts/phase2_pretrain.py) on a 10,000-molecule subset to verify loss convergence before launching the full 760K run.